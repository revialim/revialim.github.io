...
module.exports = { allLessonsList: [                
  {
    ...
    vocabulary: [
      {german: "Hanna", english: "female given name", chinese: "女性名"},
      {german: "Marie", english: "female given name", chinese: "女性名"},
  ...
  },
  {
    ...
    practiceText: {
      german: [
            <span key="name1" className="name">Marcel:</span>,
            "Hey, kann ich mir einen Stift ausleihen?",
            <br key="br1"/>, 
            <br key="br2"/>,
            <span key="name2" className="name">Alex:</span>,
            "Ja. Möchtest du den Bleistift oder den Kugelschreiber?",
            <br key="br3"/>, 
            <br key="br4"/>,
            <span key="name3" className="name">Marcel:</span>,
            "Den Kugelschreiber, bitte!",
            <br key="br5"/>, 
            <br key="br6"/>,
            <span key="name4" className="name">Alex:</span>,
            "Hier.",
            <br key="br7"/>, 
            <br key="br8"/>,
            <span key="name5" className="name">Marcel:</span>,
            "Dankeschön!"
            ], 
      english: [
            <span key="name1" className="name">Marcel:</span>,
    ...
    vocabulary: [
      {german: "Marcel", english: "male given name", chinese: "男性名"},
      {german: "Alex", english: "male given name", chinese: "男性名"},
      {german: "können", english: "can, be able to", chinese: "會，可以，能"},
      {german: "möchten (Konj.II), mögen (Infinitiv)", english: "used here as: to want, would like", chinese: "想要"},
      {german: "ausleihen", english: "to borrow", chinese: "借"},
      {german: "Stift", english: "pen", chinese: "筆"},
      {german: "Bleistift", english: "pencil", chinese: "鉛筆"},
